...
/**
* @Description: 代码生成器企业端专用 
* @Param:  
* @return:  
* @Author: wangshiwen
* @Date: 16:51 
*/ 
public class MybatisGeneratorCompany {
/**
 * <p>
 * 读取控制台内容
 * </p>
 */
    ...
    public static void main(String[] args) {
        ...
        ///修改第一处
        dsc.setUrl("jdbc:postgresql://localhost:5432/postgres?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
...
//        pc.setServiceImpl("service.impl."+str);//ServiceImpl包名
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
               ...
               /* return projectPath + "/springcloud-api/src/main/resources/mapper/" + pc.getModuleName()
                ...
                return projectPath + "/src/main/resources/mapper/"+str+"/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
        /*
